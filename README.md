...
# Server Metrics 2026-03-16 14:58:27 UTC
...
telemt_uptime_seconds 4834.4 (1h 20m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 56199
...
telemt_upstream_connect_attempts_per_request{bucket="1"} 964
...
telemt_me_writer_pick_total{mode="p2c",result="success_try"} 52345
...
telemt_user_connections_total{user="hello"} 52281
telemt_user_connections_current{user="hello"} 602
telemt_user_octets_from_client{user="hello"} 1183383836 (1.10 GB)
telemt_user_octets_to_client{user="hello"} 32277386192 (30.06 GB)
...
telemt_uptime_seconds 2399.1 (0h 39m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 24348
telemt_connections_bad_total 282
telemt_handshake_timeouts_total 129
telemt_upstream_connect_attempt_total 23138
...
telemt_upstream_connect_duration_success_total{bucket="gt_1000ms"} 2486
telemt_upstream_connect_duration_fail_total{bucket="gt_1000ms"} 18
telemt_me_floor_mode{mode="adaptive"} 1
telemt_user_connections_total{user="hello"} 23116
telemt_user_connections_current{user="hello"} 492
telemt_user_octets_from_client{user="hello"} 286869501 (273.58 MB)
telemt_user_octets_to_client{user="hello"} 4952079283 (4.61 GB)
telemt_user_msgs_from_client{user="hello"} 351601
telemt_user_msgs_to_client{user="hello"} 1447949
...
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 22432
...
telemt_me_reconnect_attempts_total 33419
...
telemt_me_writer_pick_total{mode="p2c",result="success_try"} 20120
...
telemt_user_connections_total{user="hello"} 21074
telemt_user_connections_current{user="hello"} 268
telemt_user_octets_from_client{user="hello"} 230597138 (219.91 MB)
telemt_user_octets_to_client{user="hello"} 3428359782 (3.19 GB)
...
telemt_uptime_seconds 5083.2 (1h 24m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 40483
...
telemt_me_route_drop_no_conn_total 13051
telemt_me_writer_pick_total{mode="p2c",result="success_try"} 38188
...
telemt_user_connections_total{user="hello"} 38168
telemt_user_connections_current{user="hello"} 418
telemt_user_octets_from_client{user="hello"} 768872920 (733.25 MB)
telemt_user_octets_to_client{user="hello"} 9139332620 (8.51 GB)
...
telemt_uptime_seconds 2543.7 (0h 42m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 13825
...
telemt_me_route_drop_no_conn_total 2868
telemt_me_writer_pick_total{mode="p2c",result="success_try"} 8478
...
telemt_user_octets_from_client{user="hello"} 238330460 (227.29 MB)
telemt_user_octets_to_client{user="hello"} 1301353532 (1.21 GB)
...
telemt_uptime_seconds 4651.2 (1h 17m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 57800
...
telemt_me_route_drop_no_conn_total 24005
telemt_me_route_drop_channel_closed_total 6
telemt_me_writer_pick_total{mode="p2c",result="success_try"} 53903
...
telemt_user_connections_total{user="hello"} 53768
telemt_user_connections_current{user="hello"} 738
telemt_user_octets_from_client{user="hello"} 1234429720 (1.15 GB)
telemt_user_octets_to_client{user="hello"} 14965805556 (13.94 GB)
