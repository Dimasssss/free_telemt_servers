...
# Server Metrics 2026-03-01 11:11:01 UTC
...
telemt_uptime_seconds 266.0 (0h 4m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 244
telemt_user_connections_total{user="hello"} 236
telemt_user_connections_current{user="hello"} 29
telemt_user_octets_from_client{user="hello"} 794484 (775.86 KB)
telemt_user_octets_to_client{user="hello"} 60490442 (57.69 MB)
telemt_user_msgs_from_client{user="hello"} 1612
...
telemt_uptime_seconds 274.3 (0h 4m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
...
telemt_user_octets_from_client{user="hello"} 51596 (50.39 KB)
telemt_user_octets_to_client{user="hello"} 249878 (244.02 KB)
telemt_user_msgs_from_client{user="hello"} 132
telemt_user_msgs_to_client{user="hello"} 197
```
...
telemt_uptime_seconds 308.9 (0h 5m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 1
telemt_user_connections_total{user="hello"} 1
telemt_user_octets_from_client{user="hello"} 251 (251 B)
telemt_user_octets_to_client{user="hello"} 271 (271 B)
...
telemt_uptime_seconds 85.3 (0h 1m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
```