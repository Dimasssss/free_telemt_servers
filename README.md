...
# Server Metrics 2026-03-06 12:46:26 UTC
...
telemt_uptime_seconds 8668.8 (2h 24m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 21855
telemt_connections_bad_total 3032
telemt_handshake_timeouts_total 118
telemt_upstream_connect_attempt_total 18057
telemt_upstream_connect_success_total 18054
telemt_upstream_connect_fail_total 3
telemt_upstream_connect_attempts_per_request{bucket="1"} 18057
telemt_upstream_connect_duration_success_total{bucket="le_100ms"} 17187
telemt_upstream_connect_duration_success_total{bucket="101_500ms"} 860
telemt_upstream_connect_duration_success_total{bucket="gt_1000ms"} 7
telemt_upstream_connect_duration_fail_total{bucket="gt_1000ms"} 3
telemt_me_floor_mode{mode="adaptive"} 1
telemt_user_connections_total{user="hello"} 18052
telemt_user_connections_current{user="hello"} 158
telemt_user_octets_from_client{user="hello"} 310063362 (295.70 MB)
telemt_user_octets_to_client{user="hello"} 11648496915 (10.85 GB)
telemt_user_msgs_from_client{user="hello"} 412724
telemt_user_msgs_to_client{user="hello"} 1812312
...
telemt_uptime_seconds 8668.3 (2h 24m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
...
telemt_upstream_connect_attempt_total 3109
telemt_upstream_connect_success_total 3107
telemt_upstream_connect_fail_total 2
telemt_upstream_connect_attempts_per_request{bucket="1"} 3109
...
telemt_user_octets_from_client{user="hello"} 44296097 (42.24 MB)
telemt_user_octets_to_client{user="hello"} 1691765450 (1.58 GB)
telemt_user_msgs_from_client{user="hello"} 71066
telemt_user_msgs_to_client{user="hello"} 510381
...
telemt_me_floor_mode{mode="adaptive"} 1
telemt_user_connections_total{user="hello"} 3102
telemt_user_connections_current{user="hello"} 22
telemt_user_octets_from_client{user="hello"} 56845824 (54.21 MB)
telemt_user_octets_to_client{user="hello"} 1049493264 (1000.87 MB)
telemt_user_msgs_from_client{user="hello"} 63127
telemt_user_msgs_to_client{user="hello"} 236857
telemt_user_unique_ips_current{user="hello"} 10
...
telemt_uptime_seconds 8666.8 (2h 24m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 6052
...
telemt_me_floor_mode{mode="adaptive"} 1
telemt_user_connections_total{user="hello"} 5621
telemt_user_connections_current{user="hello"} 30
telemt_user_octets_from_client{user="hello"} 89832274 (85.67 MB)
telemt_user_octets_to_client{user="hello"} 1413952120 (1.32 GB)
telemt_user_msgs_from_client{user="hello"} 92606
telemt_user_msgs_to_client{user="hello"} 405259
...
telemt_me_floor_mode{mode="adaptive"} 1
telemt_user_connections_total{user="hello"} 3481
telemt_user_connections_current{user="hello"} 21
telemt_user_octets_from_client{user="hello"} 75115193 (71.64 MB)
telemt_user_octets_to_client{user="hello"} 7538835952 (7.02 GB)
telemt_user_msgs_from_client{user="hello"} 119311
telemt_user_msgs_to_client{user="hello"} 1324039
