...
На всех серверах используется один и тот же конфиг.
...
- Локация: Finland
- Тариф: FI-200
- Краткое описание: 2 vCore, 4 Gb ram, 1 gbit/s, Traffic Unlime
- Цена в месяц: 12$
- Оплачен до: 25 марта
...
# Server Metrics 2026-02-26 09:09:14 UTC
...
telemt_uptime_seconds 2817.4 (0h 46m)
...
telemt_user_msgs_from_client{user="hello"} 74
...
telemt_uptime_seconds 171.1 (0h 2m)
```