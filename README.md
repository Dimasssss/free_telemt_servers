...
# Server Metrics 2026-03-05 22:55:12 UTC
...
telemt_uptime_seconds 2392.5 (0h 39m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 39418
telemt_connections_bad_total 36965
...
telemt_user_octets_from_client{user="hello"} 18258301 (17.41 MB)
telemt_user_octets_to_client{user="hello"} 2575211030 (2.40 GB)
telemt_user_msgs_from_client{user="hello"} 44513
telemt_user_msgs_to_client{user="hello"} 354623
...
telemt_user_octets_from_client{user="hello"} 1267614 (1.21 MB)
telemt_user_octets_to_client{user="hello"} 71833556 (68.51 MB)
telemt_user_msgs_from_client{user="hello"} 3244
telemt_user_msgs_to_client{user="hello"} 21517
...
telemt_uptime_seconds 2390.7 (0h 39m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
...
telemt_user_octets_from_client{user="hello"} 324844 (317.23 KB)
telemt_user_octets_to_client{user="hello"} 4584215 (4.37 MB)
telemt_user_msgs_from_client{user="hello"} 784
telemt_user_msgs_to_client{user="hello"} 1917
...
telemt_uptime_seconds 2393.3 (0h 39m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 298
...
telemt_user_octets_from_client{user="hello"} 9837801 (9.38 MB)
telemt_user_octets_to_client{user="hello"} 1548388663 (1.44 GB)
telemt_user_msgs_from_client{user="hello"} 27986
telemt_user_msgs_to_client{user="hello"} 269115
telemt_user_unique_ips_current{user="hello"} 3
telemt_user_unique_ips_recent_window{user="hello"} 1
```
...
telemt_uptime_seconds 2393.1 (0h 39m)
telemt_telemetry_core_enabled 1
telemt_telemetry_user_enabled 1
telemt_telemetry_me_level{level="normal"} 1
telemt_connections_total 788
...
telemt_me_floor_mode{mode="adaptive"} 1
telemt_user_connections_total{user="hello"} 350
telemt_user_connections_current{user="hello"} 12
telemt_user_octets_from_client{user="hello"} 6415337 (6.12 MB)
telemt_user_octets_to_client{user="hello"} 1077554165 (1.00 GB)
telemt_user_msgs_from_client{user="hello"} 17286
telemt_user_msgs_to_client{user="hello"} 208089
telemt_user_unique_ips_current{user="hello"} 3
telemt_user_unique_ips_recent_window{user="hello"} 1
```