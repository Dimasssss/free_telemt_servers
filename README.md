...
# Server Metrics 2026-02-28 04:49:16 UTC
...
telemt_uptime_seconds 19362.0 (5h 22m)
telemt_connections_total 2466
telemt_connections_bad_total 56
telemt_user_connections_total{user="hello"} 2386
telemt_user_connections_current{user="hello"} 3
telemt_user_octets_from_client{user="hello"} 1796381 (1.71 MB)
telemt_user_octets_to_client{user="hello"} 9062860 (8.64 MB)
telemt_user_msgs_from_client{user="hello"} 6999
telemt_user_msgs_to_client{user="hello"} 16530
```
...
telemt_uptime_seconds 19188.2 (5h 19m)
...
telemt_uptime_seconds 19356.2 (5h 22m)
...
telemt_uptime_seconds 20499.2 (5h 41m)
...
telemt_uptime_seconds 19349.8 (5h 22m)
